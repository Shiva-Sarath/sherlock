...
<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2">
  <div class="form-container px-4 py-5 signin-form semitransparent">
    <h1 class="text-left text-dark pb-2" style="font-weight:600;">Sign In <br> Here</h1>
      <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <div class="form-group py-2">
          <input required type="text" class="form-control" id="login_phone" placeholder="Phone" name="phone" maxlength="10" onkeydown="phoneNumber(this,event);" value="<?php echo $phone; ?>">
        </div>
        <div class="form-group py-2">
          <input required type="password" class="form-control" id="login_password" placeholder="Password" name="pass" spellcheck="false">
        </div>
        <div class="form-group py-2">
          <button type="reset" class="btn btn-danger left py-2 px-4 my-2">Reset</button>
          <button type="submit" class="btn btn-success right py-2 px-4 my-2" name="login">Log In</button>
        </div>
      </form>
    </div>
</div>
